...
<div class="card mt-2">
	<div class="card-body">
		<button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#tambah-data">
			Tambah Data
		</button>
	</div>
	<div class="card-body">
				...
				while($d = mysqli_fetch_array($data)){
					...
					<tr>
						...
						<td>
							...
							<button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#tambah-stok<?php echo $d['ProdukID']; ?>">
								Tambah Stok
							</button>
							<?php if($d['Stok'] == 0) { ?>
